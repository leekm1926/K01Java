...
public class E02StringMethod {
	...
	public static void main(String[] args) {
		...
		/*
		3]compareTo()
		 	: 두 문자열의 첫번째 문자부터 순차적으로 비교하면서 앞의 문자열의 아스키코드가 크면 양수를 반환,
		...
		/*
		 11]lastIndexOf()
		 	: 사용법은 indexOf()와 동일하나 문자열의 뒤에서부터 문자열을 찾아서 인덱스를 반환한다.
		 */
		...
		/*
		 14]substring()
		 	...
		 	사용2 : substring(index1, index2) -> 인덱스에 포함되는 부분만 잘라서 반환한다.
		 */
		...
		int beginIndex = filename.lastIndexOf(".")+1;//lastIndexOf를 사용하여 뒤에서부터 .을 찾아 +1을 하면 j의 자리로 간다.
