...
public class E01WrapperClass2 {
	...
	public static void main(String[] args) {
		...
		/*
		 실수형태의 문자열을 실수로 변경할때는 parseInt()는 사용할 수 없고 parseFloat()를 사용해야한다.
		 */
		...
		/*
		 6] 대소문자를 판단하는 메소드
		 	: 영문자에만 적용되고 알파벳이 아닌경우 무조건 false를 반환한다.ㅣ
		 */
		...
		System.out.println("총 공백의 갯수 : "+ whiteCount);
