...
/*
 equals()메소드
 -자바에서 인스턴트의 내용비교를 위해 비교연산자 (==)를 사용하는 것은
	단순히 참조값에 대한 비교이므로 실제 내용에 대한 비교는 이루어지지 않는다.
-인스턴트간의 내용비교를 위해서는 equals()메소드를 각 클래스에 맞게 적절히 오버라이딩하여 사용해야 한다.
...
class IntNumber{
	...
	/*
	 equals()메소드가 어떻게 인스턴스간의 내용을 비교하는지 설명하기 위한 코드로 구성 됨.
	 */
...
public class E04Object2MyEquals {
	...
	public static void main(String[] args) {
		...
		//기본클래스인 String 클래스의 인스턴스 비교, 둘 다 참조값(주소값)을 가지고 있다.
