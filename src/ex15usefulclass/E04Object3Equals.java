...
class MyClass{
	...
	public String toString() {
		...
		//valueOf()메소드를 사용하지 않는다면 아래와 같이 ""을 연결해야 한다.
		//return "" + data;
	}
	...
	public boolean equals(Object obj) {
		...
		{
			/*
			 매개변수로 전달된 객체가 MyClass의 인스턴스가 아니라면 비교의 대상이 될 수 없으므로
			 false를 반환한다.
			 */
			return false;
		}
...
class Point{
	...
	/*
	 객체 1,2의 x, y값을 동시에 비교하여 둘 다 동일할 때 같은 객체로 판단하도록 오버라이딩 했음
	 */
	@Override
	public boolean equals(Object obj) {
...
public class E04Object3Equals {
	public static void main(String[] args) {
		...
		//toString()메소드에 오버라이딩 한 내용을 출력. 출력결과는 동일 함.
		...
		//서로다른 객체에 대한 비교
		System.out.println("서로다른 객체의 비교 결과 : " + pos1.equals(mc1));
