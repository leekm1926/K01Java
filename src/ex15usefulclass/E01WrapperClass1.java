...
public class E01WrapperClass1 {
	...
	public static void main(String[] args) {
		...
		/*
		 자바의 모든 클래스는Object클래스를 상속받는다.
		 그러므로 아래 메소드를 사용할 수 있다.
		 
		 toString() : 인스턴스 변수를 출력시 참조값이 아니라 실제 저장된 값을 문자열 형태로 반환해준다.
		...
		System.out.println("numObj"+numObj.hashCode());
