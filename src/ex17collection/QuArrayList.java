...
class Student{
	...
	/*
	 toString()은 Object클래스에서 제공하는 메소드로 print()문을 통해 객체를 출력하면 자동으로 호출되는 메소드이다.
	 */
	@Override
...
public class QuArrayList {
	...
	public static void main(String[] args) {
		...
		{
			System.err.println("검색결과있음");
			System.err.println("객체 삭제 후 정보출력");
			/*
			 컬렉션에 저장된 객체를 인덱스를 통해 삭제하면 삭제된 객체 자체를 반환하게되므로
			 멤버메소드를 바로 호출할 수 있다.
			 */
