...
public class Ex01GenericBasic {
	...
	public static void main(String[] args) {
		...
		/*
		 OrangeBox에 Orange객체를 생성한 후 저장하고 정보 출력 함.
		 */
		OrangeBox oBox1 = new OrangeBox();
		Orange orange1 = new Orange(10);//당도가 10인 오렌지
		oBox1.store(orange1);
		...
		/*
		 ...
		 다른 객체를 저장하기위해서는 또 다른 Box클래스를 생성해야한다.
		 */
		/*
		...
		*/
		...
		/*
		 Object를 기반으로 한 FruitBox는 구현에는 편리하나 코드레벨에서 컴파일 에러가 발생하지 않으므로,
		 오류를 찾아내기가 훨씬 더 힘들다.
