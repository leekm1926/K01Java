...
/*
 클래스가 클래스를 상속 할 때 => extends
 클래스가 인터페이스를 상속 받을 때 => implements
 인터페이스가 인터페이스를 상속 할 때 => extends를 사용한다.
...
class PersonalNumberStorageImpl implements PersonalNumberStorageInter{
	...
	/*
	 상속을 통해 추상메소드를 포함하게 되었으므로 반드시 아래와 같이 오버라이딩을 해야한다.(필수!)
	 */
	/*
	...
	/*
	 주민번호를 인자로 전달 받아 객체배열에 저장된 정보를 검색한 후 일치하는 경우에만 이름을 반환한다.
	 */
	@Override
...
public class E02AbstractToInterface2 {
	...
	public static void main(String[] args) {
		...
		System.out.println(storage.searchPersonalInfo("001023-1090333"));
	}
