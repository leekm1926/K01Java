...
/*
 ...
 단, 이 경우 객체를 생성하지 못하게되므로 부모의 abstract메소드를 오버라이딩 하면된다.
 */
class AbsClassChild2 extends AbsClass2{
	@Override
	void absMethod(int number) {

		System.out.println("부모클래스에서 오버라이딩한 메소드로 없을 땐 에러발생함.");
	}
	void newMethod()
	{
...
public class E01AbstractBasic {
	...
	public static void main(String[] args) {
		...
		/*
		 추상클래스로 인스턴스 생성은 할 수 없으나 참조변수로 사용하는것은 가능하다.
		 */
		...
		*/
		...
		/*
		 추상클래스내에 선언된 정적멤버는 오버라이딩의 대상이아니므로 static이 가진 기본규칙을 따른다.
		 즉, 클래스명으로 접근하면된다.
		 */
