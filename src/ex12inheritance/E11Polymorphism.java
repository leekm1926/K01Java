...
public class E11Polymorphism {
	public static void main(String[] args) {
		...
		parent1.parentMethod();//오버라이딩했으므로 자식쪽 호출됨
		
		/*
		 이질화 : 자식에서 새롭게 정의한 멤버(변수, 메소드)에는 부모타입의 참조변수로 접근 불가능함.
		 		만약 접근해야 한다면 자식타입으로 형변환(강제형변환 혹은 Down캐스팅)이후 자식의 멤버에
		 		접근해야 함.
		 */
